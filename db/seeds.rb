...
start_time = Time.zone.local(2017, 1, 1)
end_time = Time.zone.local(2020, 1, 1)
Event.create(name: 'NUANSA', category: category, description: "
  ...
  velit ut velit finibus interdum laoreet vel leo. Nulla tempor turpis sed
  orci suscipit laoreet. Etiam nec nibh tellus. Ut ut nulla at justo tristique
  dapibus et eget diam. Cras interdum nulla orci, at auctor sem fermentum ac.
  Donec nec vulputate sem, ut finibus purus. Cras id odio id diam rutrum
  feugiat id ac odio. Praesent vitae odio arcu. Phasellus placerat nibh sed ex
  dictum malesuada. Quisque efficitur, est ac porttitor mattis, nisl dolor
